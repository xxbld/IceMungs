...
//        Object[] titles = {R.string.nav_menu_school, "null", null, "履历a"};
        ...
        Object[] fragments = new Object[]{UseTabFragment.newInstance(R.string.nav_menu_school), new ResumeFragment(),
                UseTabFragment.newInstance(R.string.nav_menu_verbose), new ResumeFragment()};
