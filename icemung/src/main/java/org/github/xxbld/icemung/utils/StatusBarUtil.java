...
public class StatusBarUtil {
     ...
     * @param color    状态栏颜色值 getResources().getColor()
     */
     ...
     *
     * @param activity
     * @param isFitsSystemWindows 图片全屏时 false
     */
    public static void setTranslucent(Activity activity, boolean isFitsSystemWindows) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            // 设置状态栏透明
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            // 设置根布局的参数
